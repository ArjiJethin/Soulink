...
const userPreferences = {
    characters: [
        ...
        { name: "Dad", relation: "Family" },
        { name: "Therapist", relation: "Professional" },
        { name: "Sibling", relation: "Family" },
        { name: "Colleague", relation: "Work" },
        { name: "Partner", relation: "Significant Other" },
        { name: "Coach", relation: "Professional" },
        { name: "Grandparent", relation: "Family" },
        { name: "Cousin", relation: "Family" },
        { name: "Neighbor", relation: "Community" },
        { name: "Mentor", relation: "Professional" },
        { name: "Friend from School", relation: "Friend" },
        { name: "Pet", relation: "Companion" },
        { name: "Spiritual Advisor", relation: "Professional" },
        { name: "Child", relation: "Family" },
        { name: "Aunt/Uncle", relation: "Family" },
        { name: "Friend from Gym", relation: "Friend" },
        { name: "Roommate", relation: "Living Situation" },
        { name: "Boss", relation: "Work" },
    ],
};
...
export default function Journal() {
    ...
    const highlightMentions = (input) => {
        ...
        return input.replace(mentionRegex, `<span class="mention">$1</span>`);
    };
    ...
    const handleChange = (e) => {
        ...
        if (match) {
            ...
            const suggestions = (
                userPreferences.characters?.length
    ...
    const updateCaretPosition = (textarea) => {
        ...
        const lineHeight =
            parseFloat(cs.lineHeight) || parseFloat(cs.fontSize) || 20;
