...
export default function Journal() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        localStorage.setItem('latestJournalAnalysis', JSON.stringify({
  ...
  const handleSaveAsDraft = async () => {
    ...
    localStorage.setItem('journalDrafts', JSON.stringify(drafts.slice(0, 10))); // Keep only 10 drafts
    ...
    <div className="journal-container dark-theme">
      ...
      <div className="journal-content">
        <div className="journal-header">
          ...
          <h1>Daily Journal</h1>
          <p>Write down your thoughts, feelings, and reflections for today</p>
        </div>
        ...
        <div className="journal-editor">
          <div className="editor-toolbar">
            ...
            <div className="word-count">
              {journalEntry.split(' ').filter(word => word.length > 0).length} words
            </div>
          </div>
